...
define("EW_PROJECT_ID", "{A5768E41-1B3D-4EFB-93F0-AE1113F97625}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'DqlnKydwlyUhWTmC', TRUE); // Random key for encryption
...
define("EW_CONN_USER", 'furahiam_whatsap', TRUE);
define("EW_CONN_PASS", 'Thecompany1', TRUE);
define("EW_CONN_DB", 'furahiam_whatsapi', TRUE); 
...
// User table filters
define("EW_USER_TABLE", "`account`",  TRUE);
define("EW_USER_NAME_FILTER", "(`login_id` = '%u')",  TRUE);
define("EW_USER_ID_FILTER", "(`client_id` = %u)",  TRUE);
