...
$Chart->ID = "view1_Chart1"; // Chart ID
$Chart->SetChartParms(array(array("type", "4", FALSE),
...
$Chart->SetChartParms(array(array("showLimits", "1"),
	...
	array("showAsBars", "0"),
	array("animation", "1"),
	array("showAboutMenuItem", "1"),
	array("useEllipsesWhenOverflow", "1"),
	array("theme", "ocean"),
	array("use3DLineShift", "1"),
	));
$Chart->ChartGridConfig = '{}';
$Chart->Trends[] = array(0, 0, "00FF00", "", 1, "0", "1", 100, "", "0", "0", 0, 0, "");
?>
<?php
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_view1_Chart1", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_view1_Chart1_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
