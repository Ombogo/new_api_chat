...
function ewr_AutoLoad($class) {
	...
	if (substr($class, 0, 2) == "cr") {
		if ($class == "crmywhatsa_what_db") {
			$file = "mywhatsa_whatdb2.php";
		} else {
		$fn = "%cls%info.php";
...
function CurrentProjectID() {
	...
	return "{51A9135F-DBBD-48B4-AE7D-B16D2452622C}";
}
...
include_once($EWR_RELATIVE_PATH . "phpmailer527/class.phpmailer.php");
