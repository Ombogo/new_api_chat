...
define("EWR_PROJECT_ID", "{51A9135F-DBBD-48B4-AE7D-B16D2452622C}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "project2", TRUE); // Project Name
define("EWR_PROJECT_VAR", "project2", TRUE); // Project Var
...
define("EWR_CONN_USER", 'mywhatsa_what1', TRUE);
define("EWR_CONN_PASS", 'Company1', TRUE);
define("EWR_CONN_DB", 'mywhatsa_what', TRUE);
...
define("EWR_RANDOM_KEY", '6aSk4qi8Dwx5ouDh', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/project2.css", TRUE); // Project stylesheet file name
