...
$status_add = NULL; // Initialize page object first

class cstatus_add extends cstatus {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "statusview.php")
	...
	function AddRow($rsold = NULL) {
		...
		if (!$Security->IsAdmin() && $Security->IsLoggedIn()) { // Non system admin
			$rsnew['account_id'] = CurrentUserID();
		}
...
// Create page object
if (!isset($status_add)) $status_add = new cstatus_add();

// Page init
$status_add->Page_Init();

// Page main
$status_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$status_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var status_add = new ew_Page("status_add");
status_add.PageID = "add"; // Page ID
var EW_PAGE_ID = status_add.PageID; // For backward compatibility

// Form object
var fstatusadd = new ew_Form("fstatusadd");
...
fstatusadd.Form_CustomValidate = 
...
fstatusadd.ValidateRequired = true;
<?php } else { ?>
fstatusadd.ValidateRequired = false; 
<?php } ?>
...
<?php $status_add->ShowPageHeader(); ?>
<?php
$status_add->ShowMessage();
?>
<form name="fstatusadd" id="fstatusadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($status_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $status_add->Token ?>">
<?php } ?>
