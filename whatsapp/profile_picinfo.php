...
//
// Table class for profile_pic
//
class cprofile_pic extends cTable {
	var $id;
	var $url;
	var $tdate;
	var $account_id;
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`profile_pic`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("profile_picview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("profile_picview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "profile_picadd.php?" . $this->UrlParm($parm);
		else
			return "profile_picadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("profile_picedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("profile_picadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("profile_picdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
		...
		$this->tdate->ViewValue = ew_FormatDateTime($this->tdate->ViewValue, 5);
		$this->tdate->ViewCustomAttributes = "";
		...
		// tdate
		$this->tdate->LinkCustomAttributes = "";
		$this->tdate->HrefValue = "";
		$this->tdate->TooltipValue = "";
	...
	function RenderEditRow() {
		...
		// tdate
		$this->tdate->EditAttrs["class"] = "form-control";
		$this->tdate->EditCustomAttributes = "";
		$this->tdate->EditValue = ew_HtmlEncode(ew_FormatDateTime($this->tdate->CurrentValue, 5));
		$this->tdate->PlaceHolder = ew_RemoveHtml($this->tdate->FldCaption());
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `profile_pic`";
