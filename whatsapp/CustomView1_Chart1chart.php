...
$Chart->ID = "CustomView1_Chart1"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_CustomView1_Chart1", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_CustomView1_Chart1_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
